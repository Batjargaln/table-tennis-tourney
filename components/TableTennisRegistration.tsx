...
const TableTennisRegistration: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    const hasSelectedSkillGroup = Object.values(formData.skillGroups).some(value => value);
    if (!hasSelectedSkillGroup) newErrors.skillGroups = 'Заавал нэгийг сонгоно уу!';
  ...
  if (submitted) {
    return (
      <div className="bg-blue-50 p-8 rounded-lg shadow-md max-w-md mx-auto">
        <h2 className="text-2xl font-bold text-blue-800 mb-4">Бүртгэл амжилттай!</h2>
        <p className="text-blue-700 mb-4">Бүртгүүлсэнд баярлалаа, {formData.firstName}!</p>
        <button
  ...
  return (
    <div className="bg-blue-50 p-8 rounded-lg shadow-md max-w-md mx-auto">
      <h2 className="text-2xl font-bold text-blue-800 mb-6">Тэмцээний бүртгэл</h2>
