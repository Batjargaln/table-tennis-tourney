    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-lg border border-white/50">
          <h3 className="text-xl font-bold text-blue-900 mb-4">Анхаарна уу!</h3>
          <p className="text-blue-800/70">
            Дээр дурдсан аль нэг тодорхойлолт танд байвал та тэр төрөлд хамаарна.
            Тоглогчид саналаараа өөрийн сонгосон төрлөөс дээшээ тоглох нээлттэй (+$20). Та өөрийгөө болон бусдыг хүндэтгэн үзэж өөрийн тохирсон төрөлдөө орохыг хүсье!
          </p>
        </div>
      </div>
    </div>
